...
// в терминале заново.
const CONSOLE_BUILD = '2026-09-18.5';
...
function screenLegalOffer() {
  screenEl().innerHTML = publicPageWrapHtml('Публичная оферта', `
    ...
    <div class="card">
      ...
      <p class="small muted">Исполнитель не осуществляет фискализацию чеков и эквайринг. По 54-ФЗ для фискализации нужны отдельная онлайн-касса, договор с оператором фискальных данных (ОФД) и регистрация ККТ в ФНС; для приёма карт — отдельный договор с банком-эквайером. Все эти договоры Заказчик заключает самостоятельно (см. раздел FAQ). Исполнитель не гарантирует бесперебойную работу инфраструктуры сторонних облачных провайдеров (см. страницу «Статус»).</p>
