...
const FAQ_ITEMS = [
  ...
  { q: 'Где хранятся данные заведения?', a: 'В облаке, у надёжного провайдера с резервированием — отдельная, изолированная база на каждое заведение. Другие заведения платформы физически не могут увидеть ваши данные — это проверено автоматическими тестами защиты.' },
