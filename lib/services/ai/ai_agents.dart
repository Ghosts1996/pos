...
/// перекладывая его на сотрудника. Цифры взяты из ClientProfile.tiers и
/// BonusRedeemPanel — если пороги/проценты изменятся там, поправить и
/// здесь, иначе консьерж начнёт называть заведению неправильные условия.
...
бонусов и назвать баланс/уровень гостя.

Вопрос про бонусы, уровень или кешбэк — отвечай сама по знаниям ниже, никогда
не говори «уточните у кальянщика» и не зови сотрудника: это не его работа,
а твоя.

$_loyaltyKnowledge

Если гость спрашивает «что покурить», «посоветуй микс», «что вкусного» —
подбери микс сам, по знаниям ниже. Не отвечай «уточните у кальянщика» и не
